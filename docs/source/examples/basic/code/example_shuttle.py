from fish2eod import BaseFishModel, ElectricImageParameters, Rectangle, plotting
...
class PreyClass(BaseFishModel):
    ...
    def add_geometry(self, **kwargs):
        ...
        self.model_geometry.add_domain("shuttle", shuttle, sigma=self.SHUTTLE_CONDUCTANCE)
